...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (grip-mode use-package markdown-mode ag multiple-cursors dockerfile-mode web-beautify json-mode rainbow-delimiters slime-volleyball flycheck-gometalinter helm company-go ivy magit projectile go-mode php-mode company-terraform terraform-doc terraform-mode))))
(custom-set-faces
